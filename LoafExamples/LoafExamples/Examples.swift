...
class Examples: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case .vertical:
            Loaf(example.rawValue, sender: self).show()
        case .left:
            Loaf(example.rawValue, presentingDirection: .left, dismissingDirection: .left, sender: self).show()
        case .right:
            Loaf(example.rawValue, presentingDirection: .right, dismissingDirection: .right, sender: self).show()
        case .mix:
